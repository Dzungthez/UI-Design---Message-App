...
//            }
        ...
        contactList.setCellFactory(param -> new ListCell<String>() {
            ...
            public void updateItem(String name, boolean empty) {
                ...
                if (empty) {
                    ...
                    Image image;
                    try {
                        image = new Image(AppUI.class.getResourceAsStream("image/" + name + ".png"));
                    } catch (Exception e) {
                        image = new Image(AppUI.class.getResourceAsStream("image/default.png"));
                    }
    ...
    public void initialize(URL url, ResourceBundle resourceBundle) {
        ...
        try {
            FXMLLoader fxmlLoader = new FXMLLoader(AppUI.class.getResource("myMessage.fxml"));
